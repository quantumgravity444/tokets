...
contract Tokets is StandardToken {
    ...
    string public eventTime;                     // Date and time of the event
    ...
    function Tokets(
        ...
        eventTime = _eventTime;                                  // Set the date and time for display purposes
        location = _location;                                    // Set the event location for display purposes
        retailPrice = _retailPrice;                              // Set the retail price for display purposes
    }
}